...
<div class="container">
    ...
    <div class="">
       <!--  <div class="row mt-5">
        ...
        <div class="row mt-4 bg-white border-rounded mb-5" style='padding-top: 0 !important'>
            
            <div class="w-100 pt-5 pl-5 pr-5 pb-1">
                ...
                <div class="col-md-12">
                    <p class="h4 font-weight-lighter text-center">CALIFICACIÓN</p>
                    <hr class="">
                </div>
            </div>
