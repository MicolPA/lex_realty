    ...
    <div class="row mt-5">
        ...
        <div class="col-md-3 rounded bg-white pb-2">
            <div>
                ...
                <a href="/frontend/web/desarrolladores/index?id=<?= $model->desarrollador->id ?>&stars=1" class="btn-block text-center p-0 pt-2 pb-2 btn btn-outline-success h6">DESARROLLADOR</a>

                <a href="/frontend/web/propiedades/ver-dictamen?id=<?= $model->id ?>&propiedad_check=0" class="btn-block text-center p-0 pt-2 pb-2 btn btn-outline-dark h6" target='_blank'>DESCARGAR DICTAMEN</a>

                <a href="/frontend/web/tasas-hipotecarias" class="btn-block text-center p-0 pt-2 pb-2 btn btn-outline-primary h6">TASAS HIPOTECARIAS</a>
