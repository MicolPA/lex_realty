    ...
    <div class="row mt-5">
        ...
        <div class="col-md-3 rounded bg-white pb-2">
            <div>
                ...
                <a href="/frontend/web/desarrolladores/index?id=<?= $model->desarrollador->id ?>&stars=1" class="btn-block text-success text-center p-0 pt-2 pb-2 btn btn-outline-success h6">DESARROLLADOR</a>
