...
/**
 * PreConstruccionesSearch represents the model behind the search form of `frontend\models\PreConstrucciones`.
 */
class PreConstruccionesSearch extends PreConstrucciones
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'tipo_propiedad', 'ubicacion_id', 'habitaciones', 'baños', 'riezgo_id', 'impuestos', 'cargas_gramabes', 'deslinde', 'certificado_titulo', 'permisos_municipales', 'permiso_ambiental', 'objeccion_ministerio_turismo', 'permiso_obras_publicas', 'confortur', 'user_id'], 'integer'],
            [['titulo_publicacion', 'celular_contacto', 'detalles', 'fecha_publicacion', 'foto_1', 'foto_2', 'foto_3', 'foto_4'], 'safe'],
        ];
    }
    ...
    public function search($params, $ubicaciones=array(), $tipos=array())
    {
        ...
        $query = PreConstrucciones::find()->orderBy([$sort => $sort_type]);
        $ub_all = array();
